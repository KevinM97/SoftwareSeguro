...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="d-flex flex-column p-3 justify-content-around text-center">
        <h1 class="p-2">Bares</h1>
        <table class="table">
            <thead class="thead-dark">
                <tr>
                    <th scope="col">#</th>
                    <th scope="col">Nombre</th>
                    <th scope="col">Esta Abierto</th>                   
                </tr>
            </thead>
            <tbody>
            <?php
            ...
            ?>
                <tr>
                    <th scope="row"><?php echo $mostrar['bar_id'] ?></th>
                    <td><?php echo $mostrar['bar_nombre'] ?></td>
                    <td><?php echo $mostrar['bar_abierto'] ?></td>
                </tr>
                <?php
                    }
                ?>         
