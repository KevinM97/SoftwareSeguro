...
<body>
    ...
    <div class="d-flex flex-column p-3 justify-content-around text-center">
        ...
        <table class="table">
            ...
            ?>
                <tr>
                    <th scope="row"><?php echo $mostrar['men_id'] ?></th>
                    <td><?php echo $mostrar['men_nombre'] ?></td>
                    <td><?php echo $mostrar['men_precio'] ?></td>
                    <td><?php echo $mostrar['men_disponible'] ?></td>
                    <td><?php echo $mostrar['men_descripcion'] ?></td>
                </tr>
                <?php
                    }
                ?>
